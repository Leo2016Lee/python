...
def create_qrcode(url, qrcodename, logoPicPath):
    qr = qrcode.QRCode(
        version=1,  # 设置容错率为最高
...
create_qrcode("https://www.zhihu.com/question/20501628", "edwe",
              "F:\\VScode\\python\\pythonExercise\\pythonExercise\\05.png"),
